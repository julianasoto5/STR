...
public class ReLogoObserver extends BaseObserver{
	...
	public AgentSet<subtes1.relogo.Pasajero> createPasajeros(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Pasajero")
	public AgentSet<subtes1.relogo.Pasajero> createPasajeros(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Pasajero")
	public AgentSet<subtes1.relogo.Pasajero> createOrderedPasajeros(int number, Closure closure) {
		AgentSet<subtes1.relogo.Pasajero> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Pasajero")
	public AgentSet<subtes1.relogo.Pasajero> createOrderedPasajeros(int number) {
	...
	public AgentSet<subtes1.relogo.Pasajero> pasajeros(){
		...
		for (Object e : this.getContext().getObjects(subtes1.relogo.Pasajero.class)) {
	...
	public AgentSet<subtes1.relogo.Subte> createSubtes(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Subte")
	public AgentSet<subtes1.relogo.Subte> createSubtes(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Subte")
	public AgentSet<subtes1.relogo.Subte> createOrderedSubtes(int number, Closure closure) {
		AgentSet<subtes1.relogo.Subte> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.Subte")
	public AgentSet<subtes1.relogo.Subte> createOrderedSubtes(int number) {
	...
	public AgentSet<subtes1.relogo.Subte> subtes(){
		...
		for (Object e : this.getContext().getObjects(subtes1.relogo.Subte.class)) {
	...
	public AgentSet<subtes1.relogo.UserTurtle> createUserTurtles(int number, Closure closure) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.UserTurtle")
	public AgentSet<subtes1.relogo.UserTurtle> createUserTurtles(int number) {
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.UserTurtle")
	public AgentSet<subtes1.relogo.UserTurtle> createOrderedUserTurtles(int number, Closure closure) {
		AgentSet<subtes1.relogo.UserTurtle> result = new AgentSet<>();
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes1.relogo.UserTurtle")
	public AgentSet<subtes1.relogo.UserTurtle> createOrderedUserTurtles(int number) {
	...
	public AgentSet<subtes1.relogo.UserTurtle> userTurtles(){
		...
		for (Object e : this.getContext().getObjects(subtes1.relogo.UserTurtle.class)) {
	...
	public AgentSet<subtes1.relogo.UserLink> userLinks(){
		...
		for (Object e : this.getContext().getObjects(subtes1.relogo.UserLink.class)) {
	...
	public subtes1.relogo.UserLink userLink(Number oneEnd, Number otherEnd) {
		return (subtes1.relogo.UserLink)(this.getNetwork("UserLink").getEdge(turtle(oneEnd),turtle(otherEnd)));
	}
