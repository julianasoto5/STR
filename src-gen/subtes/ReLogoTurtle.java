...
public class ReLogoTurtle extends BaseTurtle{
	...
	/**
	 * Makes a number of new cabinas and then executes a set of commands on the
	 * created cabinas.
	 * 
	 * @param number
	 *            a number
	...
	public AgentSet<subtes.relogo.Cabina> hatchCabinas(int number, Closure closure) {
		AgentSet<subtes.relogo.Cabina> result = new AgentSet<>();
		AgentSet<Turtle> createResult = this.hatch(number,closure,"Cabina");
	 ...
	 */
	@ReLogoBuilderGeneratedFor("subtes.relogo.Cabina")
	public AgentSet<subtes.relogo.Cabina> hatchCabinas(int number) {
		return hatchCabinas(number,null);
	}
